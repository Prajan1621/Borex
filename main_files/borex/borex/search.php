...
$search_banner = borex_option('search_banner', true);
$search_layout = borex_option('search_layout', 'right-sidebar');
                ...
                <div class="col-lg-12 my-auto">
                    <div class="banner-content text-<?php echo esc_attr( $banner_text_align ); ?>">
                        <h2 class="banner-title"><?php
		                    ...
		                    printf( esc_html__( 'Search Results for: %s', 'borex' ), '<span>' . get_search_query() . '</span>' );
		                    ?>
                        </h2>
